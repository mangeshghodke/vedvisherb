...
export default function Contact() {
  ...
  const contactInfo = [
    { icon: Phone, label: t('contactPhone'), sub: t('contactPhoneSub') },
    { icon: Mail, label: t('contactEmail'), sub: t('contactEmailSub') },
    { icon: MapPin, label: t('contactAddr'), sub: t('contactAddrSub') },
    { icon: MessageCircle, label: t('contactWa'), sub: t('contactWaSub') },
  ]
            ...
            >
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 mb-5">
                ...
                <div>
                  ...
                  >
                    <option value="" className="bg-ayur-900">{t('contactSubjectDefault')}</option>
                    <option value="product" className="bg-ayur-900">{t('contactSubject1')}</option>
                    <option value="consultation" className="bg-ayur-900">{t('contactSubject2')}</option>
                    <option value="order" className="bg-ayur-900">{t('contactSubject3')}</option>
                    <option value="wholesale" className="bg-ayur-900">{t('contactSubject4')}</option>
                    <option value="other" className="bg-ayur-900">{t('contactSubject5')}</option>
                  </select>
                </div>
              </div>
